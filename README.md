...
| Tests | Vitest (253 test blocks) + ESLint + `tsc`, all gated in CI |
...
```bash
cd workers   && npx tsc --noEmit && npm test    # 253 vitest test blocks
...
**Everything is deployed and working.** All 45 API endpoints resolve, all 13
