...
| Tests | Vitest (308 test blocks) + ESLint + `tsc`, all gated in CI |
...
```bash
cd workers   && npx tsc --noEmit && npm test    # 308 vitest test blocks
...
| Database (D1) | ✅ 25 migrations applied, seeded |
