...
| Tests | Vitest (248 test blocks) + ESLint + `tsc`, all gated in CI |
...
```bash
cd workers   && npx tsc --noEmit && npm test    # 248 vitest test blocks
...
| Database (D1) | ✅ 22 migrations applied, seeded |
