...
const NOTES = {
  ...
  '/api/grammar/exercises': '38,995-item graded bank; ?level=1-5 &kind=',
  ...
  '/api/session/plan': 'mixed due items + daily loop; reuses today\'s open row',
  '/api/session/complete': 'journals results, applies FSRS, stores reflection',
  '/api/grammar/elided': 'one implied-فاعل item, live from quran_syntax',
};
