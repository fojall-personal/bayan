...
-- database and a full create against a fresh one. Later migrations alter from
-- here. Do not edit this file; add a new migration instead.
...
-- Was a bare INSERT, so re-running the schema failed on duplicate keys.
INSERT OR IGNORE INTO tajweed_rules (id, name, description, color, color_name) VALUES
